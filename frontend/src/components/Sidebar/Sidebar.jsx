import { Layers, Users, Trophy, Zap, Activity, ShieldAlert, Settings, Database, AlertTriangle, UserCheck } from 'lucide-react';
      ...
      <div className="sidebar-scroll-area">
          ...
          {isAdmin && (
            <div className="sidebar-section" style={{ marginTop: '32px' }}>
              ...
              <button
                className={`nav-button ${location.pathname === '/anomalies' ? 'active' : ''}`}
              ...
              <button
                className={`nav-button ${location.pathname === '/attendance' ? 'active' : ''}`}
